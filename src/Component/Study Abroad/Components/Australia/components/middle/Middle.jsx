  ...
  const table1 = [
    {
      ...
      rows: [
        ...
        { 'Key Facts': 'International Students', Details: 'Over 40,000 studying in Australia ' },
        { 'Key Facts': 'Popular Universities', Details: 'University of Australia, University of Sydney, Australian National University ' },
        { 'Key Facts': 'Visa', Details: 'Tier 4 ' },
  ...
  const table2 = [
    {
      ...
      rows: [
        { 'University Name': 'University of Australia', 'Best Known for': 'Engineering and Applied S', 'Benefits(including Scholarships': 'Offers various scholarship for international  students based on merit and need recognized degree', },
        { 'University Name': 'Australian National University', 'Best Known for': 'Engineering and Technology', 'Benefits(including Scholarships': 'Provides scholarships for outstanding students strong focus  on research and international cooperation', },
        { 'University Name': 'University of Sydney', 'Best Known for': 'Engineering & Medicine', 'Benefits(including Scholarships': 'Offers a range of scholarships, including merit based  and need based options largest English taught  university in Australia',  },
        { 'University Name': 'University of Melbourne', 'Best Known for': 'Medicine and Health Sciences', 'Benefits(including Scholarships': 'Scholarships available for high achieving students known for its modern facilities and international partnership',},
        { 'University Name': 'University of Queensland', 'Best Known for': 'Arts and Humanities', 'Benefits(including Scholarships': 'Offers various financial aid options strong  emphasis on student satisfaction and support services.',  },
        { 'University Name': 'Monash University', 'Best Known for': 'Environmental Science and Research', 'Benefits(including Scholarships': 'Provides research grants and scholarship for postgraduate students focuses on sustainability and innovation', },
  ...
  return (
    <div> 
      ...
      <div className={middlecss.table2}>
        ...
        <h2 data-aos="fade-left" data-aos-easing="ease-in-out" data-aos-once="true">Why invest your time when you can access expert assistance at no cost? Connect with SunRay to receive FREE guidance for studying in Australia today!</h2>
      </div>
