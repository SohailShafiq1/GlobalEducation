  ...
  const table1 = [
    {
      ...
      rows: [
        ...
        { 'Key Facts': 'International Students', Details: 'Over 40,000 studying in Belarus ' },
        { 'Key Facts': 'Popular Universities', Details: 'Belarusian State University, Belarusian National Technical University, Gomel State Medical University ' },
        { 'Key Facts': 'Visa', Details: 'Tier 4 ' },
  ...
  const table2 = [
    {
      ...
      rows: [
        { 'University Name': 'Belarusian State University', 'Best Known for': 'Engineering and Applied S', 'Benefits(including Scholarships': 'Offers various scholarship for international  students based on merit and need recognized degree', },
        { 'University Name': 'Belarusian National Technical University', 'Best Known for': 'Engineering and Technology', 'Benefits(including Scholarships': 'Provides scholarships for outstanding students strong focus  on research and international cooperation', },
        { 'University Name': 'Gomel State Medical University', 'Best Known for': 'Engineering & Medicine', 'Benefits(including Scholarships': 'Offers a range of scholarships, including merit based  and need based options largest English taught  university in Cyprus',  },
  ...
  return (
    <div> 
      ...
      <div className={middlecss.table2}>
        <h1 data-aos="fade-right" data-aos-easing="ease-in-out" data-aos-once="true">Top Universities in Belarus </h1>
        <p data-aos="fade-right" data-aos-easing="ease-in-out" data-aos-once="true">Belarus is home to numerous prestigious universities that are consistently ranked among the best in the region. For international students, these institutions represent a chance to receive top-tier education, exposure to a diverse culture, and potentially brighter career opportunities.</p>
        ...
        <h2 data-aos="fade-left" data-aos-easing="ease-in-out" data-aos-once="true">Why invest your time when you can access expert assistance at no cost? Connect with SunRay to receive FREE guidance for studying in Belarus today!</h2>
      </div>
