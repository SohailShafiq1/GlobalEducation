...
const NorthCyprus = () => {
  return (
    <div className={Ukcss.top}>
      <h1 style={{textAlign: 'center', color: '#1a3c40', margin: '2rem 0 1.5rem 0', fontWeight: 700, fontSize: '2.2rem'}}>Study in North Cyprus</h1>
      <div className={Ukcss.section}>
        <h2 style={{color: '#2d4a53'}}>Benefits of Studying in North Cyprus</h2>
        <ul style={{marginLeft: '1.5rem', color: '#1a3c40'}}>
          ...
          <li>Modern campuses and facilities</li>
        </ul>
      </div>
      <div className={Ukcss.section}>
      ...
      <div className={Ukcss.section}>
        <h2 style={{color: '#2d4a53'}}>Why Apply to North Cyprus?</h2>
        <ul style={{marginLeft: '1.5rem', color: '#1a3c40'}}>
          ...
          <li>Rich culture and Mediterranean lifestyle</li>
        </ul>
      </div>
      <blockquote style={{margin: '2.5rem auto', maxWidth: 600, background: '#e6f0ee', borderLeft: '5px solid #1a3c40', borderRadius: 8, padding: '1.2rem 1rem', color: '#1a3c40', fontSize: '1.15rem', fontStyle: 'italic', textAlign: 'center'}}>
        "We will guide you every step of the way to make your dream of studying in North Cyprus a reality."
      </blockquote>
      <div className={Ukcss.section}>
        <h2 style={{color: '#2d4a53'}}>Frequently Asked Questions</h2>
        <ul style={{marginLeft: '1.5rem', color: '#1a3c40'}}>
          <li><strong>Can I work while studying in North Cyprus?</strong> Yes, international students can work part-time during their studies, subject to local regulations.</li>
          ...
          <li><strong>What is the cost of living in North Cyprus?</strong> The cost varies by city, but students should budget for accommodation, food, transport, and personal expenses. On average, €5,000–€8,000 per year.</li>
          <li><strong>Is health insurance required?</strong> Yes, health insurance is mandatory for all international students in North Cyprus.</li>
        </ul>
      </div>
      <div className={Ukcss.section}>
        <h2 style={{color: '#2d4a53'}}>Contact Us for Personalized Guidance</h2>
        <p style={{color: '#1a3c40', fontSize: '1.08rem'}}>Our experienced counselors are here to help you with every step of your application, from choosing the right course to preparing your visa documents. <br/>Reach out today and start your journey to North Cyprus with confidence!</p>
      </div>
    </div>
  )
}
