      ...
      <div className={popularcourses.container}>
        <div className={popularcourses.text}>
          <h1
            ...
            data-aos-once="true"
          >
            Popular Courses to Studying in the Cyprus
          </h1>
          <p
            data-aos="fade-up"
            data-aos-easing="ease-in-out"
            data-aos-once="true"
          >
            International students in the Cyprus are presented with an
            ...
            study in a Cyprus university or seeks the best courses to study in
            the Cyprus, the opportunities for intellectual growth and
          ...
          >
            ...
            <li>
              <strong>Marine Sciences:</strong> Leverages Cyprus's coastal
          ...
          <p
            ...
            data-aos-once="true"
          >
            The Cyprus's educational tapestry weaves together diverse
            opportunities for international students in the Cyprus, resonating
            with the spirit of exploration and learning. As international
            students study in the Cyprus, they partake in a transformative
        ...
        >
          ...
          Then click to discover more about the Best Courses to Study in the
          Cyprus for International Students!
        </p>
      </div>
    </div>
  );
